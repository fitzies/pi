...
tools: read, fffind, ffgrep, grep, find, ls
thinking: low
...
- Prefer FFF tools almost always for discovery: use `fffind` for fuzzy/path search and `ffgrep` for content search before reading files.
