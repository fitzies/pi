...
description: Production-ready CSS transitions and motion tokens for web apps. Use when implementing or reviewing UI motion such as badges, dropdowns, modals, panels, page transitions, card resizing or tilt, number and text changes, icon swaps, success and error feedback, avatar hovers, input clearing, skeletons, shimmer, sliding tabs, tooltips, staggered reveals, morphing menus, accordions, toasts, like buttons, checkboxes, counters, or toggles. Also use for requests to add, improve, audit, refine, or tokenize transitions and animations, including the commands transitions reveal, transitions review, transitions apply, and transitions refine.
---
