...
// no timers, no Metal, no CADisplayLink to tear down. SwiftUI may throttle
// timelines that are no longer rendered, but callers should still drive
// `paused` explicitly when retaining many non-visible orbs.
    ...
    public var body: some View {
        ...
        Group {
            if let frozenTime {
                ...
                // One static, deterministic frame at the same raw engine
                // instant used by the web and React Native implementations.
